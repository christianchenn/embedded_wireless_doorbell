...
String sendPhoto() {
  ...
  if (client.connect(serverName.c_str(), serverPort)) {
    ...
    client.println("Content-Type: multipart/form-data; boundary=Doorbell");
    client.println();
    client.print(head);
...
const int timerInterval = 2500;    // time between each HTTP POST image
...
void loop() {
  ...
  TEMP_BUTTON = digitalRead(0);
  /*
  * Start Logic Here
  */
  if(TEMP_BUTTON  && !STATE_BUTTON ){
